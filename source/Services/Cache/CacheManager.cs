...
namespace FriendsAchievementFeed.Services
{
    ...
    public sealed class CacheManager : ICacheManager
    {
        ...
        private void RaiseCacheChangedSafe()
        {
            ...
            {
                _logger?.Error(e, StringResources.ErrorNotifySubscribers);
            }
        }
        ...
        private void EnsureFriendFeedLoaded_NoPolicy()
        {
            ...
            global.LastUpdatedUtc = DateTimeUtilities.AsUtcKind(global.LastUpdatedUtc);
        ...
        private void TrySyncPerGameFilesToMatchGlobal_NoPolicy()
        {
            ...
            {
                _logger?.Error(e, StringResources.ErrorFileOperationFailed);
            }
        }
        ...
        private void SaveFriendFeedToDisk_NoPolicy()
        {
            ...
            _globalFriendFeed.LastUpdatedUtc = DateTimeUtilities.AsUtcKind(_globalFriendFeed.LastUpdatedUtc);
        ...
        public SelfAchievementGameData LoadSelfAchievementData(string key)
        {
            ...
            {
                _logger?.Error(ex, StringResources.GetString("LOCFriendsAchFeed_Error_FileOperationFailed"));
                return null;
            }
        }
